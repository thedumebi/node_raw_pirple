...
var { performance: _performance, PerformanceObserver } = require("perf_hooks");
      ...
      if (!err && userData) {
        ...
        if (hashedPassword === userData.hashedPassword) {
          ...
          _data.create("tokens", tokenId, tokenObject, function (err) {
            ...
            debug("\x1b[33m%s\x1b[0m", "about to get entries by type");
            var obs = new PerformanceObserver(function (observer) {
              var measurements = observer.getEntries();
