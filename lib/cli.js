    ...
    if (!err && userIds && userIds.length > 0) {
      ...
      userIds.forEach(function (userId) {
        _data.read("users", userId, function (err, userData) {
          if (!err && userData) {
            var line = `\x1b[33mName:\x1b[0m ${userData.firstName} ${userData.lastName} \x1b[33mPhone:\x1b[0m +${userData.phone} \x1b[33mChecks:\x1b[0m `;
            var numberOfChecks =
    ...
    if (!err && checkIds && checkIds.length > 0) {
      ...
      checkIds.forEach(function (checkId) {
        _data.read("checks", checkId, function (err, checkData) {
          ...
          // Get state of check but default to down
          var state =
          ...
          if (
            ...
            var line = `\x1b[33mID:\x1b[0m ${
              checkData.id
            } \x1b[33m${checkData.method.toUpperCase()}\x1b[0m ${
              checkData.protocol
            }://${checkData.url} \x1b[33mState:\x1b[0m ${stateOrUnknown}`;
            console.log(line);
            cli.verticalSpace();
          }
        });
...
cli.init = function () {
  ...
  // If the user stops the CLI, ill the associated process
